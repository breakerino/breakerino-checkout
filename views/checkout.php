...
<form name="checkout" method="post" data-brk-checkout-form class="<?= implode(' ', $formClasses); ?>" action="<?= esc_url(wc_get_checkout_url()); ?>" enctype="multipart/form-data" aria-label="<?= esc_attr__('Checkout', 'woocommerce'); ?>">
