...
<label data-brk-ecommerce-checkout-id="<?= esc_attr($paymentMethod->id); ?>" class="brk-ecommerce-checkout-method brk-ecommerce-checkout-method--payment<?= $selectedMethod === $paymentMethod->id ? ' brk-ecommerce-checkout-method--selected' : ''; ?>"  for="payment_method_<?= esc_attr($paymentMethod->id); ?>">
	<div class="brk-ecommerce-checkout-method__inner">
		...
		<div class="brk-ecommerce-checkout-method__content">
			<span class="brk-ecommerce-checkout-method__label"><?= esc_html($paymentMethod->get_title()); ?></span>
		</div>
	...
	<?php if ($paymentMethod->has_fields() || $paymentMethod->get_description()) : ?>
		<div class="brk-ecommerce-checkout-method__after payment_box payment_method_<?php echo esc_attr($paymentMethod->id); ?>" <?php if (! $paymentMethod->chosen) : ?>style="display:none;" <?php endif; ?>>
